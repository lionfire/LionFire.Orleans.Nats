...
namespace LionFire.Orleans_.Storage
{
    ...
    internal class NatsGrainKey
    {
        ...
        public NatsGrainKey(long key, string keyExtension)
        {
            N0Key = 0;
            N1Key = key;
        ...
        public NatsGrainKey(Guid key, string keyExtension)
        {
        ...
        public NatsGrainKey(string key)
        {
            StringKey = key;
            N0Key = 0;
            N1Key = 0;
